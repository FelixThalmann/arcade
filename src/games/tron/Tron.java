...
//Main (music anfang, KEYS einfuegen, hintergung einfuegen, erstellung der spieler, feld deklarieren, winner Implimentierung)
	public Tron(JPanel panel, KeyRequest KEYS) {
		...
		// Logisch Spieler
		Player P1 = new Player(KEYS, -1, 0, 1, 1, floor, 1, tileSize, width, height, Seat.P1_PlayerView); // Player1 erstellen
		Player P2 = new Player(KEYS, (width) - 1, -1, -1, 1, floor, 2, tileSize, width, height, Seat.P2_PlayerView); 
		Player P3 = new Player(KEYS, (width), (height) - 1, -1, -1, floor, 3, tileSize, width,height, Seat.P3_PlayerView);
		Player P4 = new Player(KEYS, 0, (height), 1, -1, floor, 4, tileSize, width, height, Seat.P4_PlayerView);
